...
# Extract options
function __fish_andiacoin_tx_get_options
...
# Extract commands
function __fish_andiacoin_tx_get_commands
...
# Add options
complete \
    --command andiacoin-tx \
    --condition "not __fish_andiacoin_seen_cmd (__fish_andiacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_andiacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command andiacoin-tx \
    --arguments "(__fish_andiacoin_tx_get_commands)" \
    --no-files
