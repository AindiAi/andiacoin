...
complete --command andiacoind --no-files

# Extract options
function __fish_andiacoind_get_options
...
complete \
    --command andiacoind \
    --arguments "(__fish_andiacoind_get_options --nofiles)"
