...
(define* (make-andiacoin-cross-toolchain target
                                       #:key
...
desirable for building Andiacoin Core release binaries."
...
;; failure; see https://github.com/andiacoin/andiacoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-andiacoin-cross-toolchain target)))
