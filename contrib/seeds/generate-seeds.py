...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ANDIACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define ANDIACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the andiacoin network\n')
    ...
    g.write('#endif // ANDIACOIN_CHAINPARAMSSEEDS_H\n')
