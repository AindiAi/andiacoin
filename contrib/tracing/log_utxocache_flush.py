...
"""Example logging Andiacoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/andiacoind
...
def main(andiacoind_path):
    ...
    # to the tracepoints
    andiacoind_with_usdts.enable_probe(
        probe="flush", fn_name="trace_flush")
    b = BPF(text=program, usdt_contexts=[andiacoind_with_usdts])
