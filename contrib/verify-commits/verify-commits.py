...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/andiacoin-core/andiacoin-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['ANDIACOIN_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
