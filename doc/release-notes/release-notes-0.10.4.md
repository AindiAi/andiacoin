Andiacoin Core version 0.10.4 is now available from:

  <https://andiacoin.org/bin/andiacoin-core-0.10.4/>
...
- #6953 `43c2789` Split andiacoin-tx into its own package
- #6953 `dfe0d4d` Include andiacoin-tx binary on Debian/Ubuntu
