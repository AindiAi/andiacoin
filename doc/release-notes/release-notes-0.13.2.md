Andiacoin Core version 0.13.2 is now available from:

  <https://andiacoin.org/bin/andiacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update andiacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow andiacoin-tx to create v2 transactions (btcdrak)
