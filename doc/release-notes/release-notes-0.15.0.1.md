Andiacoin Core version *0.15.0.1* is now available from:

  <https://andiacoin.org/bin/andiacoin-core-0.15.0.1/>

and

  <https://andiacoincore.org/bin/andiacoin-core-0.15.0.1/>
