Andiacoin Core version *0.15.2* is now available from:

  <https://andiacoincore.org/bin/andiacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in andiacoin-tx (TheBlueMatt)
