Andiacoin Core version 0.16.1 is now available from:

  <https://andiacoincore.org/bin/andiacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting andiacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure andiacoind processes are cleaned up when tests end (sdaftuar)
