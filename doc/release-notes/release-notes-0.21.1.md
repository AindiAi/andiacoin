...
Andiacoin Core version 0.21.1 is now available from:

  <https://andiacoincore.org/bin/andiacoin-core-0.21.1/>
...
fungibility of all andiacoins. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Andiacoin Core's wallet is
...
FAQ](https://andiacoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/andiacoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/andiacoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/andiacoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Andiacoin](https://andiacoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-andiacoin)
  - [What do Schnorr Signatures Mean for Andiacoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-andiacoin)
...
- Development history overview
  - [Taproot](https://andiacoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://andiacoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://andiacoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://andiacoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://andiacoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/andiacoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/andiacoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to andiacoin.conf documentation (jonatack)
