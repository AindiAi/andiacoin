Andiacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/andiacoin/files/Andiacoin/andiacoin-0.5.4/
...
http://gitorious.org/andiacoin/andiacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Andiacoin-Qt notifications under Growl 1.3.
Increase required age of Andiacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAndiacoin properly when installing Andiacoin-Qt over it. (Windows)
