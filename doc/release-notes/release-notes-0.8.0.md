Andiacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/andiacoin/files/Andiacoin/andiacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Andiacoin
...
New/changed settings (command-line or andiacoin.conf file)
--------------------------------------------------------
