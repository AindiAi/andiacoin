Andiacoin Core version 0.9.2.1 is now available from:

  https://andiacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ADC to 0.01 ADC
...
- Fix "Start andiacoin on system login"
