Andiacoin Core version 0.9.4 is now available from:

  https://andiacoin.org/bin/0.9.4/
...
this update is incompatible with the Andiacoin system and could lead to consensus
forks.

Andiacoin Core released binaries from https://andiacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~andiacoin/+archive/ubuntu/andiacoin
- A third-party or self-compiled Andiacoin Core

upgrade to Andiacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
