Andiacoin Core version 27.0 is now available from:

  <https://andiacoincore.org/bin/andiacoin-core-27.0/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. Andiacoin
...
libandiacoinconsensus
-------------------

- libandiacoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libandiacoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Andiacoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Andiacoin Core would
