...
This document provides guidelines for internationalization of the Andiacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `andiacoin_en.ts` remains unchanged.
