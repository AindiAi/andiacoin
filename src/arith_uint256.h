...
#ifndef ANDIACOIN_ARITH_UINT256_H
#define ANDIACOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Andiacoin only uses this "compact" format for encoding difficulty
...
#endif // ANDIACOIN_ARITH_UINT256_H
