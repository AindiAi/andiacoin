...
#ifndef ANDIACOIN_COMMON_ARGS_H
#define ANDIACOIN_COMMON_ARGS_H
...
extern const char * const ANDIACOIN_CONF_FILENAME;
extern const char * const ANDIACOIN_SETTINGS_FILENAME;
