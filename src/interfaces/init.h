...
#ifndef ANDIACOIN_INTERFACES_INIT_H
#define ANDIACOIN_INTERFACES_INIT_H
...
//! (andiacoin-gui, andiacoin-node, andiacoin-wallet, andiacoind, andiacoin-qt) and each
...
#endif // ANDIACOIN_INTERFACES_INIT_H
