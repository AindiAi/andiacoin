...
#ifndef ANDIACOIN_INTERFACES_NODE_H
#define ANDIACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a andiacoin node (andiacoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or andiacoin.conf.
...
#endif // ANDIACOIN_INTERFACES_NODE_H
