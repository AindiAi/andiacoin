...
#ifndef ANDIACOIN_IPC_CAPNP_COMMON_TYPES_H
#define ANDIACOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common andiacoin types.
namespace mp {
...
#endif // ANDIACOIN_IPC_CAPNP_COMMON_TYPES_H
