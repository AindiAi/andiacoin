...
#ifndef ANDIACOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define ANDIACOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // ANDIACOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
