...
#ifndef ANDIACOIN_NODE_CONNECTION_TYPES_H
#define ANDIACOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/andiacoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Andiacoin’s Peer-to-Peer Network")
...
#endif // ANDIACOIN_NODE_CONNECTION_TYPES_H
