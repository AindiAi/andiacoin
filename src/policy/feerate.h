...
#ifndef ANDIACOIN_POLICY_FEERATE_H
#define ANDIACOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "ADC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    ADC_KVB,      //!< Use ADC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::ADC_KVB) const;
...
#endif // ANDIACOIN_POLICY_FEERATE_H
