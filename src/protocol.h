...
#ifndef ANDIACOIN_PROTOCOL_H
#define ANDIACOIN_PROTOCOL_H
...
/**
 * Andiacoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Andiacoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // andiacoin-development mailing list. Remember that service bits are just
