...
#ifndef ANDIACOIN_PSBT_H
#define ANDIACOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Andiacoin transaction.) Returns true if the merge succeeded, false otherwise. */
