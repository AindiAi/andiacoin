...
#ifndef ANDIACOIN_QT_ANDIACOINGUI_H
#define ANDIACOIN_QT_ANDIACOINGUI_H
...
/**
  Andiacoin GUI main class. This class represents the main window of the Andiacoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AndiacoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AndiacoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AndiacoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a andiacoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, AndiacoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Andiacoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(AndiacoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // ANDIACOIN_QT_ANDIACOINGUI_H
