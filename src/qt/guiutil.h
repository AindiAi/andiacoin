...
#ifndef ANDIACOIN_QT_GUIUTIL_H
#define ANDIACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Andiacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "andiacoin:" URI into recipient object, return true on successful parsing
