      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->andiacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->andiacoinAtStartup);
    ...
    ui->andiacoinAtStartup->setToolTip(ui->andiacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->andiacoinAtStartup->setText(ui->andiacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openAndiacoinConfButton->setToolTip(ui->openAndiacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AndiacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->andiacoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSADControls);
...
void OptionsDialog::on_openAndiacoinConfButton_clicked()
{
