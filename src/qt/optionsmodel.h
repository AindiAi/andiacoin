...
#ifndef ANDIACOIN_QT_OPTIONSMODEL_H
#define ANDIACOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Andiacoin client.
...
public:
    ...
    AndiacoinUnit getDisplayUnit() const { return m_display_andiacoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSADControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    AndiacoinUnit m_display_andiacoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(AndiacoinUnit unit);
...
#endif // ANDIACOIN_QT_OPTIONSMODEL_H
