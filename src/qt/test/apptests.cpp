...
//! Entry point for AndiacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AndiacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AndiacoinGUI tests.
void AppTests::guiTests(AndiacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AndiacoinGUI::consoleShown, this, &AppTests::consoleTests);
