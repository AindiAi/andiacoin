...
{
    // Test regression https://github.com/andiacoin/andiacoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/andiacoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/andiacoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Andiacoin/Andiacoin-Qt.conf and all else left as default,
    // andiacoin-qt should set both -listen and -listenonion to false and start successfully.
