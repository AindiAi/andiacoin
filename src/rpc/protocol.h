...
#ifndef ANDIACOIN_RPC_PROTOCOL_H
#define ANDIACOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in andiacoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Andiacoin is not connected
...
#endif // ANDIACOIN_RPC_PROTOCOL_H
