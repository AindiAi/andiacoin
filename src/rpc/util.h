...
#ifndef ANDIACOIN_RPC_UTIL_H
#define ANDIACOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting ADC/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1ADC/kvB.
 */
