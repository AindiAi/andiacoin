...
#ifndef ANDIACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ANDIACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ANDIACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
