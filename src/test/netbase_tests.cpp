...
{
    BOOST_CHECK(TestSplitHost("www.andiacoincore.org", "www.andiacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.andiacoincore.org]", "www.andiacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.andiacoincore.org:80", "www.andiacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.andiacoincore.org]:80", "www.andiacoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.andiacoincore.org:65536", "www.andiacoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.andiacoincore.org:0", "www.andiacoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.andiacoincore.org:", "www.andiacoincore.org:", 0, false));
}
