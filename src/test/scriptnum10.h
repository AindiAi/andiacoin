...
#ifndef ANDIACOIN_TEST_SCRIPTNUM10_H
#define ANDIACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Andiacoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ANDIACOIN_TEST_SCRIPTNUM10_H
