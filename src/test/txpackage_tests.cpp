...
BOOST_FIXTURE_TEST_CASE(package_cpfp_tests, TestChain100Setup)
{
    ...
    // Now that the child's fees have "increased" by 1 ADC, the cheap package should succeed.
    {
    ...
    // Parent pays 1 ADC and child pays none. The parent should be accepted without the child.
    {
        BOOST_CHECK_EQUAL(m_node.mempool->size(), expected_pool_size);
