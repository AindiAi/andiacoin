// Copyright (c) 2019-2020 The Andiacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDIACOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define ANDIACOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // ANDIACOIN_TEST_UTIL_TRANSACTION_UTILS_H
