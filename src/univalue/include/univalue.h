...
// Copyright 2015 Andiacoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef ANDIACOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define ANDIACOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // ANDIACOIN_UNIVALUE_INCLUDE_UNIVALUE_H
