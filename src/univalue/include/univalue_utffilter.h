...
#ifndef ANDIACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define ANDIACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // ANDIACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
