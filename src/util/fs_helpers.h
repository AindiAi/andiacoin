...
// Copyright (c) 2009-2023 The Andiacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDIACOIN_UTIL_FS_HELPERS_H
#define ANDIACOIN_UTIL_FS_HELPERS_H
...
#endif // ANDIACOIN_UTIL_FS_HELPERS_H
