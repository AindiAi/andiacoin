...
#ifndef ANDIACOIN_UTIL_MESSAGE_H
#define ANDIACOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's andiacoin address, it must refer to a public key.
...
#endif // ANDIACOIN_UTIL_MESSAGE_H
