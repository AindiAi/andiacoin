...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!ancestors) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/andiacoin-dev/2018-November/016518.html
...
DisconnectResult Chainstate::DisconnectBlock(const CBlock& block, const CBlockIndex* pindex, CCoinsViewCache& view)
{
    ...
    // See https://github.com/andiacoin/andiacoin/issues/22596 for additional information.
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // in "Weaknesses in Andiacoin’s Merkle Root Construction":
        // https://lists.linuxfoundation.org/pipermail/andiacoin-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/andiacoin-dev/2019-February/016697.html.  Because CheckBlock() is
