...
#ifndef ANDIACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ANDIACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ANDIACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
