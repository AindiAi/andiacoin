...
#ifndef ANDIACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ANDIACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Andiacoin Core wallet was originally a collection of unrelated private
...
#endif // ANDIACOIN_WALLET_SCRIPTPUBKEYMAN_H
