...
#ifndef ANDIACOIN_WALLET_TRANSACTION_H
#define ANDIACOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this andiacoin node, and set to 0 for transactions that were created
...
#endif // ANDIACOIN_WALLET_TRANSACTION_H
