...
#ifndef ANDIACOIN_WALLET_WALLET_H
#define ANDIACOIN_WALLET_WALLET_H
...
public:
     ...
     * andiacoin-wallet tool code or by wallet migration code. If this is called
...
#endif // ANDIACOIN_WALLET_WALLET_H
