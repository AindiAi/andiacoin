// Copyright (c) 2017-2021 The Andiacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDIACOIN_WALLET_WALLETUTIL_H
#define ANDIACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! andiacoin from opening the wallet, thinking it was newly created, and
...
#endif // ANDIACOIN_WALLET_WALLETUTIL_H
