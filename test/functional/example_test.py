...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AndiacoinTestFramework
    pass


class ExampleTest(AndiacoinTestFramework):
    # Each functional test is a subclass of the AndiacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AndiacoinTestFramework class so other tests can use it."""
