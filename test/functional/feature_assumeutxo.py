#!/usr/bin/env python3
# Copyright (c) 2021-present The Andiacoin Core developers
...
to a hash that has been compiled into andiacoind.
...
class AssumeutxoTest(AndiacoinTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test andiacoind should fail when mempool not empty.")
        node=self.nodes[2]
