...
"""
Test starting andiacoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that andiacoind has bound on "::1" (for RPC) and "::" (for P2P).
