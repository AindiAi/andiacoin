...
class FullBlockTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure andiacoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure andiacoind isn't accepting b28
        ...
        # andiacoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the andiacoin code has custom code which does so);
