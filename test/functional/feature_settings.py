...
class SettingsTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        conf = node.datadir_path / "andiacoin.conf"

        # Assert default settings file was created
        self.stop_node(0)
        default_settings = {"_warning_": "This file is automatically generated and updated by Andiacoin Core. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
