...
class VersionBitsWarningTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because andiacoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
