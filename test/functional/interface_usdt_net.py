...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/andiacoin/andiacoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our andiacoind node")
