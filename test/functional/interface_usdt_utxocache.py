...
""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/andiacoin/andiacoin/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(AndiacoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_andiacoind_tracepoints()
    ...
    def test_uncache(self):
        ...
        https://github.com/andiacoin/andiacoin/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/andiacoin/andiacoin/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/andiacoin/andiacoin/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/andiacoin/andiacoin/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
