...
class MempoolAcceptanceTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.mempool_size = 0
        # Also check feerate. 1ADC/kvB fails
        assert_raises_rpc_error(-8, "Fee rates larger than or equal to 1ADC/kvB are not accepted", lambda: self.check_mempool_result(
        ...
        utxo_to_spend = self.wallet.get_utxo(txid=txid_in_block)  # use 0.3 ADC UTXO
