...
By default, andiacoind will dump mempool on shutdown and
...
class MempoolPersistTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent andiacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
