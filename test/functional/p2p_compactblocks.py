...
# TestP2PConn: A peer we use to send messages to andiacoind, and store responses.
...
class CompactBlocksTest(AndiacoinTestFramework):
    ...
    # This test actually causes andiacoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that andiacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for andiacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # andiacoind will not send blocktxn responses for blocks whose height is
