#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Andiacoin Core developers
...
class TxDownloadTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new andiacoind instances, as setting mocktimes has long-term effects on when
