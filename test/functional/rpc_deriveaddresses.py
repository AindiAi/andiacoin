...
class DeriveaddressesTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Before #26275, andiacoind would crash when deriveaddresses was
        # called with derivation index 2147483647, which is the maximum
        # positive value of a signed int32, and - currently - the
        # maximum value that the deriveaddresses andiacoin RPC call
