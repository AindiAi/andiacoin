...
Verify that a andiacoind node can use an external signer command.
...
class RPCSignerTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart andiacoind with -signer=<cmd>',
