...
class TestShell:
    """Wrapper Class for AndiacoinTestFramework.

    The TestShell class extends the AndiacoinTestFramework
    ...
    class __TestShell(AndiacoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AndiacoinTestFramework child class.
            self.num_nodes = 1
