...
class TxnMallTest(AndiacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ADC:
        ...
        # First: use raw transaction API to send 1240 ADC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ADC coin each
        ...
        # Node0's balance should be starting balance, plus 50ADC for another
        ...
        # Node0's total balance should be starting balance, plus 100ADC for
